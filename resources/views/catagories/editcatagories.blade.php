                ...
                <div class="row g-4">
                    <div class="col-12">
                        <div class="bg-light rounded h-100 p-4">
                            ...
                            <h6 class="mb-4">Update Catagories</h6>
                            <form action="{{ url('/admin/catagory/update/'.$catagory->id) }}" method="POST">
                                @csrf
                                <div class="mb-3">
                                    <label for="catagory_name" class="form-label">Catagory Name</label>
                                    <input type="name" class="form-control" id="catagory_name"
                                        name="catagory_name" value="{{ $catagory->catagory }}">
                                    @error('catagory_name')
                                        <p class='text-danger'>{{ $message }}</p>
                                    @enderror
                                </div>

                                @if ($catagory->catagory_status == 'enable')
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="catagory_status"
                                            id="catagory_status" value="enable" checked>
                                        <label class="form-check-label" for="enable">Enabled</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="catagory_status"
                                            id="catagory_status" value="dissable">
                                    ...
                                    @enderror
                                @endif
                                @if ($catagory->catagory_status == 'dissable')
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="catagory_status"
                                            id="catagory_status" value="enable">
                                        <label class="form-check-label" for="enable">Enabled</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="catagory_status"
                                            id="catagory_status" value="dissable" checked>
                                        <label class="form-check-label" for="disable">Dissabled</label>
                                    </div>
                                    @error('catagory_status')
                                        <p class='text-danger'>{{ $message }}</p>
