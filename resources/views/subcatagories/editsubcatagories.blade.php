                ...
                <div class="row g-4">
                    <div class="col-12">
                        <div class="bg-light rounded h-100 p-4">
                            ...
                            <h6 class="mb-4">Update Subcatagories</h6>
                            <form action="{{ url('admin/subcatagory/update/' . $subcatagory->id) }}" method="POST">
                                @csrf
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="name" class="form-control" id="subcatagory_name"
                                        name="subcatagory_name" value="{{ $subcatagory->subcatagory }}">
                                    @error('subcatagory_name')
                                        <p class='text-danger'>{{ $message }}</p>
                                    @enderror
                                </div>

                                @if ($subcatagory->subcatagory_status == 'enable')
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="subcatagory_status"
                                            id="subcatagory_status" value="enable" checked>
                                        <label class="form-check-label" for="enable">Enabled</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="subcatagory_status"
                                            id="subcatagory_status" value="dissable">
                                ...
                                @if ($subcatagory->subcatagory_status == 'dissable')
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="subcatagory_status"
                                            id="subcatagory_status" value="enable">
                                        <label class="form-check-label" for="enable">Enabled</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="subcatagory_status"
                                            id="subcatagory_status" value="dissable" checked>
                                        <label class="form-check-label" for="disable">Dissabled</label>
                                    </div>
                                    @error('subcatagory_status')
                                        <p class='text-danger'>{{ $message }}</p>
