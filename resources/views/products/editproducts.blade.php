                    ...
                    <div class="row g-4">
                        <div class="col-12">
                            <div class="bg-light rounded h-100 p-4">
                                ...
                                <form name="images-upload-form" method="POST" action="{{ url('admin/product/update/' . $product->id) }}" accept-charset="utf-8" enctype="multipart/form-data">
                                    @csrf
                                    <div class="mb-3">
                                        <label class="form-label" for="product">Product</label>
                                        <input class="form-control" id="product" name="product" type="text" value="{{ $product->product }}">
                                        @error('product')
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-control get_category" id="catagory_name" name="catagory_name" aria-label="Default select example">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        @if ($product->status == 'enable')
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" id="product_status" name="product_status" type="radio" value="enable" checked>
                                        ...
                                        @if ($product->status == 'dissable')
                                            ...
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" id="product_status" name="product_status" type="radio" value="dissable" checked>
                                                <label class="form-check-label" for="disable">Dissabled</label>
                                            </div>
                                            @error('product_status')
                                                <p class='text-danger'>{{ $message }}</p>
